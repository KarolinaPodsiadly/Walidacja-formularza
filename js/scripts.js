...
function displayErrors(errors) {
  ...
  form.addEventListener("submit", function(e) {
    ...
    e.preventDefault(); //forumalrz się nie wyśle po kliknięciu - zapobieganie defaultym ustawieniom przeglądarki

    var errors = [];

    for(var i=0;i<fields.length; i++) {
      var field = fields[i],
          isValid = false; //zakładam że formularz nie jest poprawny
